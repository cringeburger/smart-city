<template>
    <div id='myOrganization' class='paddingbottomm'>
        <Commercemenu
        v-bind:Active="isActive"/>
        <MyCommerceOrganization
...
import MyCommerceOrganization from '@/components/MyCommerceOrganization.vue'
export default {
  name: 'Profile',
  components: {
    Commercemenu,
  ...
  data(){
      return{
          isActive:[
              {Profile:false, Organization:true, Transaction:false}
          ],
          userData:{
            login:'1', 
            usertoken:'',
